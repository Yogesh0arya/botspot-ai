        ...
        <div>
            <div className="flex justify-between bg-transparent max-w-6xl xl:mx-auto items-center mx-5 pt-3 md:p-0">
                ...
                <div className="relative cursor-pointer">
                    <h1 className="font-bold text-xl text-white md:text-4xl flex-shrink-0">BOTSPOT AI</h1>
                </div>
                ...
                <div className="max-w-xs">
                    <div className="hidden lg:inline-grid mt-1 relative p-3 rounded-md ">
                        ...
                        <input type="text" placeholder="Search" className="pl-10 bg-gray-50 block w-full sm:text-sm border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" />
                    </div> 
                </div>
